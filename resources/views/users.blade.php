...
<header>
    ...
    <nav class="flex items-center bg-gray-100 px-4 py-2">
        <div class="flex items-center w-full justify-between mx-auto px-4">
            ...
            <form class="hidden md:flex md:w-5/12 flex-row" role="search">
                <div class="flex w-full">
                    <input class="form-control flex-grow px-3 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-yellow-400" type="search" placeholder="Buscar..." aria-label="Search">
            ...
            <button class="hidden md:flex bg-yellow-500 text-white hover:bg-yellow-600 px-4 py-2 rounded-md" type="button" id="openLoginModal">
