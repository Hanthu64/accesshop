<div id="admin-view" class="flex flex-col">
                ...
                <p class="text-2xl font-bold my-4 text-center">Lista de usuarios</p>

                <table class="min-w-full border border-gray-200 shadow-md bg-yellow-100 rounded-md mb-6">
                    <thead>
                    <tr>
                ...
                <p class="text-2xl font-bold my-4 text-center">Lista de productos</p>
                <table class="min-w-full border border-gray-200 shadow-md bg-yellow-100 rounded-md mb-6">
                    <thead>
                    <tr>
                        <th class="py-2 px-4 text-left">ID</th>
                    ...
                    @foreach($products as $product)
                        <tr class="border-b  {{ $loop -> odd ? 'bg-gray-200' : '' }}">
                            ...
                            <td class="py-2 px-4">{{$product -> shop_name}}</td>

                            <td class="py-2 px-4 flex justify-end">
                                <form action="{{  route("show.product", $product -> product_id) }}" method="GET">
                                    <button type="submit"
